# Blog da Li 🚀 | Tech News & Dev Lab

Um blog e laboratório prático criado para explorar novas ferramentas do mercado de tecnologia, testar agentes de Inteligência Artificial voltados para desenvolvimento (como o Jules) e compartilhar novidades da área.

🔗 **Acesse o blog:** [https://eliane-orlandin.github.io/](https://eliane-orlandin.github.io/)
...
- **[Astro](https://astro.build/):** Framework web focado na entrega de sites estáticos com altíssima performance.
- **[Tailwind CSS](https://tailwindcss.com/):** Estilização ágil e responsiva diretamente no código.
...
Para clonar e testar este ambiente na sua máquina:

```bash
# Clone o repositório
git clone [https://github.com/Eliane-orlandin/eliane-orlandin.github.io.git](https://github.com/Eliane-orlandin/eliane-orlandin.github.io.git)

# Entre na pasta
cd eliane-orlandin.github.io
